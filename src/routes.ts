...
export const routes: AppRoute[] = [
  ...
  {
    path: "/best-iptv/iptv-smarters-pro",
    indexable: true,
    rendering: "SSG",
    changefreq: "monthly",
    priority: 0.8,
