...
export const routes: AppRoute[] = [
  {
    ...
    priority: 1.0,
    lastmod: "2026-09-07",
    primaryIntent: "Brand & Primary Global IPTV Pillar",
    primaryKeyword: "best IPTV service in 2026",
    secondaryTopics: [
      "IPTV service",
      "IPTV Subscription",
      "IPTV Free Trial",
    ...
    h1: "Best IPTV Service Worldwide in 2026 — Teleview",
    title: "Best IPTV Service Worldwide 2026 | Teleview IPTV",
    description:
    ...
    ogTitle: "Best IPTV Service Worldwide 2026 | Teleview IPTV",
    ogDescription:
      "Discover Teleview, a premium IPTV service for viewers worldwide. Stream 25,000+ live channels, movies and series in HD and 4K, with IPTV Subscription plans and a free trial.",
    breadcrumbName: "Home",
  },
