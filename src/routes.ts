...
export const routes: AppRoute[] = [
  {
    ...
    h1: "IPTV Subscription for Live TV & On-Demand Streaming",
    title: "Teleview IPTV Subscription | Live TV, Sports & 24h Free Trial",
    description:
    ...
    ogTitle: "Teleview IPTV Subscription | Live TV, Sports & 24h Free Trial",
    ogDescription:
      "Teleview IPTV subscription with live TV, sports and on-demand entertainment across supported devices. Compare plans, explore setup guides and start a 24-hour trial.",
    breadcrumbName: "Home",
  },
  ...
  },
  {
    ...
    changefreq: "weekly",
    priority: 0.9,
    primaryIntent: "Commercial Investigation & Comparison Hub: Best IPTV Services & Providers",
