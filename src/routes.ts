...
export const routes: AppRoute[] = [
  {
    ...
    changefreq: "weekly",
    priority: 1.0,
    primaryIntent: "Brand & Broad IPTV Discovery",
    primaryKeyword: "IPTV",
    secondaryTopics: [
      "IPTV service",
      "IPTV subscription",
    ...
    h1: "IPTV Service & Subscription | Teleview",
    title: "Teleview IPTV | Premium Live TV & Streaming Subscription",
    description:
      "Explore Teleview premium IPTV service with 25,000+ live channels, 4K sports streaming, and on-demand movies. Compare plans, read setup guides, or start a 24h free trial.",
    ogTitle: "Teleview IPTV | Premium Live TV & Streaming Subscription",
    ogDescription:
  ...
  },
  {
    ...
    title: "IPTV Subscription: Plans, 25,000+ Channels & 4K Streaming | Teleview",
    description:
  ...
  },
  {
    ...
    primaryKeyword: "legacy-pricing-redirect",
  ...
  },
  {
    ...
    changefreq: "weekly",
    priority: 0.9,
    primaryIntent: "Dual Pillar: Best IPTV Service & Best IPTV Players Comparison",
    primaryKeyword: "best IPTV service and best IPTV players",
    secondaryTopics: [
      "best IPTV service",
      "best IPTV players",
  ...
  {
    path: "/how-does-iptv-work",
    indexable: true,
    rendering: "SSG",
    changefreq: "monthly",
    priority: 0.8,
    primaryIntent: "Informational Technical Guide",
    primaryKeyword: "how does IPTV work",
    secondaryTopics: [
      "IPTV architecture",
      "unicast vs multicast",
      "HLS and MPEG-TS",
      "hardware video decoding",
      "Xtream Codes API mechanics",
    ],
    h1: "How Does IPTV Work? The Technical Mechanics Explained",
    title: "How Does IPTV Work? Streaming Protocols & Mechanics (2026)",
    description:
      "Learn how IPTV streams video over IP networks using unicast delivery, HLS/MPEG-TS chunks, CDN edge caching, and hardware video decoding.",
    ogTitle: "How Does IPTV Work? Complete Technical Guide | Teleview",
    ogDescription:
      "Technical deep dive into packetized video streaming: signal acquisition, HEVC transcoding, and client-side hardware rendering.",
    breadcrumbName: "How IPTV Works",
  },
  {
    path: "/is-iptv-legal",
    indexable: true,
    ...
    secondaryTopics: [
      "IPTV legality 2026",
      "broadcast licensing",
      "DMCA streaming regulations",
      "copyright retransmission",
    ...
    ogDescription:
      "Clear legal analysis of IPTV technology, international copyright regulations, DMCA statutes, and provider compliance standards.",
  ...
  },
  {
    ...
    secondaryTopics: [
      "IPTV cybersecurity",
      "malicious player APKs",
      "safe streaming practices",
      "VPN streaming privacy",
      "payment safety",
    ],
    ...
    ogDescription:
      "Protect your devices and home network while streaming IPTV: safe player downloads, VPN encryption, and credential security.",
  ...
  },
  {
    ...
    ogDescription:
      "Head-to-head comparison between IPTV and legacy cable: calculate annual savings, compare channel counts, and evaluate picture quality.",
  ...
  },
  {
    ...
    secondaryTopics: [
      ...
      "international IPTV bouquets",
      "7-day XMLTV EPG",
      "sports TV channels",
      "premium movie channels",
    ],
    h1: "IPTV Channels: Complete Guide to Global Live TV Feeds (2026)",
    title: "IPTV Channels: 25,000+ Live TV Feeds & Guide (2026) | Teleview",
    description:
      "Browse 25,000+ live IPTV channels organized by regional bouquets: national networks, sports, premium movies, international packages, and news.",
    ogTitle: "IPTV Channels: 25,000+ Live Broadcast Feeds | Teleview",
    ogDescription:
      "Explore comprehensive live channel bouquets: sports networks, international news, entertainment cinema, and 7-day EPG guides.",
    breadcrumbName: "IPTV Channels",
  },
  {
    path: "/iptv-sports",
    indexable: true,
