              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-2 leading-relaxed">
                    ...
                    are independent third-party software programs (explore the{" "}
                    ...
                    or learn{" "}
                    <a href="/what-is-iptv" className="text-phosphor-green hover:underline font-medium">how IPTV works</a>{" "}
