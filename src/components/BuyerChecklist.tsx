...
export default function BuyerChecklist() {
  return (
    <section id="buyer-checklist" className="section-y scroll-mt-16 bg-ash/10 border-y border-charcoal/40" aria-labelledby="checklist-heading">
      <div className="container-x">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4 max-w-[1140px] mx-auto">
          {buyerChecklist.criteria.map((item, i) => (
            <Reveal key={item.criterion} delay={i * 0.04} className="h-full">
              <article className="card card-hover h-full p-5 flex flex-col border-charcoal bg-ash/40">
                <div className="flex items-center gap-2 pb-3 border-b border-charcoal">
                  ...
                  <h3 className="text-sm font-bold text-snow">{item.criterion}</h3>
                </div>
        ...
        <div className="mt-16 pt-12 border-t border-charcoal/60 max-w-[1140px] mx-auto">
            ...
            {trustAndTransparency.cards.map((card, idx) => {
              ...
              return (
                <Reveal key={card.title} delay={idx * 0.06} className="h-full">
                  <article className="card h-full p-6 flex flex-col justify-between border-charcoal bg-ash/30">
                    <div>
