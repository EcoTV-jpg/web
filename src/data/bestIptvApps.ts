...
export const bestIptvAppsList: IptvAppDetail[] = [
  ...
  },
  {
    ...
    alternatives: [
      { name: "TiviMate IPTV Player", slug: "tivimate", reason: "Dedicated TV-first timeline grid interface if you only stream on Android TV or Fire TV." },
    ...
    relatedDeviceSlug: "android-tv",
    relatedDeviceName: "Android TV & Google TV Devices",
  ...
  },
  {
    ...
    relatedDeviceSlug: "samsung-smart-tv",
    relatedDeviceName: "Samsung Smart TV",
  ...
  },
  {
    ...
    relatedDeviceSlug: "lg-smart-tv",
    relatedDeviceName: "LG Smart TV (webOS)",
    relatedSetupHash: "#smart-tv",
  },
  {
    slug: "gse-smart-iptv",
    ...
    alternatives: [
      ...
      { name: "TiviMate IPTV Player", slug: "tivimate", reason: "Dedicated TV timeline interface if you switch to an Android TV or Firestick device." },
    ],
    faqs: [
      {
    ...
    relatedDeviceSlug: "apple-tv",
    relatedDeviceName: "Apple TV (tvOS)",
  ...
  },
  {
    ...
    relatedDeviceSlug: "android-tv",
    relatedDeviceName: "Android TV & Desktop",
  ...
  },
  {
    ...
    relatedDeviceSlug: "google-tv",
    relatedDeviceName: "Google TV & Android TV",
    relatedSetupHash: "#android",
  },
];
...
export const hubComparisonData: HubComparisonRow[] = [
  {
    name: "TiviMate IPTV Player",
    slug: "tivimate",
    bestFor: "Android TV & Fire TV (cable-style EPG grid)",
    platforms: "Android TV, Fire TV, Google TV",
    playlistSupport: "Xtream Codes, M3U, Stalker",
    epgQuality: "Interactive TV timeline grid with XMLTV",
    setupEase: "Play Store on Android TV; sideload on Fire TV",
    keyFeature: "Cable-box interface & multi-view (multi-line required)",
  },
  {
    name: "IPTV Smarters Pro",
    slug: "iptv-smarters-pro",
    bestFor: "Cross-platform playback (Android, iOS, PC, Mac)",
    platforms: "Android, iOS, Fire TV, Windows, Mac",
    playlistSupport: "Xtream Codes, M3U",
    epgQuality: "Category-based channel EPG guide",
    setupEase: "Direct install from official app stores",
    keyFeature: "Live TV, Movies & Series dashboard navigation",
  },
  {
    name: "IBO Player",
    slug: "ibo-player",
    bestFor: "Samsung Tizen & LG webOS Smart TVs",
    platforms: "Samsung Tizen, LG webOS, Android, Apple TV",
    playlistSupport: "M3U URL, Xtream Codes (via Web Portal)",
    epgQuality: "Standard XMLTV channel program guide",
    setupEase: "Direct install from Samsung / LG app stores",
    keyFeature: "Direct TV install & web-based MAC pairing",
  },
  {
    name: "SmartOne IPTV",
    slug: "smartone",
    bestFor: "Lightweight Smart TV remote playback",
    platforms: "LG webOS, Samsung Tizen, Vidaa OS",
    playlistSupport: "M3U URL, Xtream Codes (via Web Portal)",
    epgQuality: "Compact channel schedule guide",
    setupEase: "Direct install from Smart TV app stores",
    keyFeature: "Dual playlist support & remote number pad dialing",
  },
  {
    name: "GSE Smart IPTV",
    slug: "gse-smart-iptv",
    bestFor: "Apple ecosystem (iOS, tvOS, macOS)",
    platforms: "iPhone, iPad, Apple TV (tvOS), Mac",
    playlistSupport: "M3U, Xtream Codes, Local Files",
    epgQuality: "Multi-source XMLTV EPG parsing",
    setupEase: "Direct install from Apple App Store",
    keyFeature: "AirPlay casting & local M3U file management",
  },
  {
    name: "VLC Media Player",
    slug: "vlc",
    ...
    epgQuality: "No native EPG (raw stream playback only)",
    setupEase: "Direct installer download",
    keyFeature: "Free open-source media player & codec inspector",
  },
  {
    name: "OTT Navigator IPTV",
    slug: "ott-navigator",
    bestFor: "Advanced Android TV customization",
    platforms: "Android TV, Google TV, Fire TV",
    playlistSupport: "Xtream Codes, M3U, Stalker",
    epgQuality: "Multi-source XMLTV EPG aggregation",
    setupEase: "Play Store install; advanced settings",
    keyFeature: "Per-channel video decoders & studio PiP mode",
  },
];
