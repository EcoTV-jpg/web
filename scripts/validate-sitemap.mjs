...
// Expected 51 canonical approved sitemap paths — all indexable routes now in sitemap for indexability sync (P1 crawl fix)
...
async function validateSitemap() {
  ...
  check(
    `Sitemap contains exactly ${APPROVED_SITEMAP_PATHS.length} approved URLs`,
